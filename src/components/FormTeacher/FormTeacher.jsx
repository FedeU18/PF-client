      ...
      <form className='form'>
        <div className='formulario'>
          ...
          <div>
            ...
            <div className='label-input'>
              ...
              <input onChange={(e) =>setConfirm(e.target.value)} type="password" name='confirm' value={confirm} />
            </div>
            <div className='botones'>
              <button disabled={teacher.contraseña === confirm ? false:true} onClick={(e)=>setParte("segunda")}>Siguiente</button>
            </div>
          </div>
          }
          ...
          <div>
            ...
            <div className='label-input'>
              ...
              <select onChange={(e) => handleSelectPaises(e)}>
                {paisesSort.length && paisesSort.map(p => {
                  return (
          ...
          <div>
            <div className='label-input'>
              ...
              <textarea onChange={(e) => handleOnChange(e)} type="text" name='descripcion' value={teacher.descripcion} />
            </div>
            <div className='label-input'>
            ...
            <div className="label-input">
              ...
              <select onChange={(e) => handleSelectMaterias(e)}>
                {materiasSort.length && materiasSort.map(m => {
                  return (
        ...
        <div className='texto'>
          <div className="contenido">
            ...
            <p className='parrafo'>Ayuda a estudiantes de nivel medio a prepararse para sus exámenes</p>
          </div>
        </div>
      </form>
    </div>
