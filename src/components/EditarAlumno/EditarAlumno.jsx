...
export const EditarAlumno = ({show, handleClose,alumno}) => {
    ...
    const [userAlumno ,setUserAlumno]=useState({    name:false,
                                                    lastname:false,
                                                    age:false,
                                                    picture:false,
                                                    country:false,
    ...
    const objActualizarAlumno = (e) => {
      ...
      const updateAlumno = (e) => {
        e.preventDefault();
        dispatch(actions.editAlumno(actualizar, alumno.id));
        setActualizar({})
        setUserAlumno({    name:false,
                            lastname:false,
                            age:false,
                            picture:false,
                            country:false,
            ...
            <div className={`opEditarPErfContent ${opcionConf===1 ?'ContEditSElA':'contNoEditSElA'}`}>
              <div className="nameAlumInptChangeCont">
                {userAlumno.name===false?(
                    ...
                    <button className="btnEditProAlu">
                        <AiOutlineEdit onClick={()=>{setUserAlumno({...userAlumno,name:!userAlumno.name})}}/>
                    </button> 
              </div>
              ...
              <div className="nameAlumInptChangeCont">
                {userAlumno.lastname===false?(
                    ...
                    <button className="btnEditProAlu">
                        <AiOutlineEdit onClick={()=>{setUserAlumno({...userAlumno,lastname:!userAlumno.lastname})}}/>
                    </button> 
              </div>
              ...
              <div className="nameAlumInptChangeCont">
                {userAlumno.age===false?(
                    ...
                    <button className="btnEditProAlu">
                        <AiOutlineEdit onClick={()=>{setUserAlumno({...userAlumno,age:!userAlumno.age})}}/>
                    </button> 
              </div>
              ...
              <div className="nameAlumInptChangeCont">
                {userAlumno.country===false?(
                    ...
                    <br></br>
                    <input onChange={(e) => objActualizarAlumno(e)}  
                            list="browsers"
                            type='text' 
                    ...
                    <button className="btnEditProAlu">
                        <AiOutlineEdit onClick={()=>{setUserAlumno({...userAlumno,country:!userAlumno.country})}}/>
                    </button> 
              </div>
            </div>
          ):(
